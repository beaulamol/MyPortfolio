...
function getSiteUrl() {
    const u = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_SITE_URL;
...
function Header() {
    ...
    const headerBg = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$value$2f$use$2d$transform$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTransform"])(scrollY, [
        0,
        80
    ], [
        "rgba(10, 10, 11, 0)",
    ...
    const scrollTo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Header.useCallback[scrollTo]": (e, href)=>{
            if (href.startsWith("#")) {
                var _document_querySelector;
                e.preventDefault();
                (_document_querySelector = document.querySelector(href)) === null || _document_querySelector === void 0 ? void 0 : _document_querySelector.scrollIntoView({
                    behavior: "smooth"
                });
            }
        }
    }["Header.useCallback[scrollTo]"], []);
...
_s(Header, "68b1HCot/6ddDZ7krCFXZmcGBr8=", false, function() {
    return [
